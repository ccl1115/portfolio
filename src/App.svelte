<script lang="ts">
  ...
  function toLanguages() {
    scroller.scroll(languages.offsetTop);
  }

  function toPlatforms() {
    scroller.scroll(platforms.offsetTop);
  }

  function toProjects() {
    scroller.scroll(projects.offsetTop);
  }

  function toTools() {
    scroller.scroll(tools.offsetTop);
  }
...
<main class="m-0 p-0 h-full">
  ...
  <SmoothScroller bind:this={scroller}>
    <div>
      <div class="mt-40">
    ...
    >
      <div class="grid grid-cols-3 gap-x-20 gap-y-10 mx-20 mt-20 mb-40">
        ...
        <div class="col-span-3 lg:col-span-2 text-sm pt-1">
          <p>使用Vue/React/Svelte开发网页应用，管理后台</p>
          <p>前后端分离</p>
    ...
    <div bind:this={tools} id="tools" class="bg-white text-gray-800 py-20">
      <div
        class="grid grid-cols-2 lg:grid-cols-4 mx-10 gap-10 pt-10 mt-5 mb-40"
      >
